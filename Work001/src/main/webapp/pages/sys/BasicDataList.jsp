    ...
    <script>
        ...
        layui.use(['element','form','table','jquery','layer'], function(){
            ...
            function renderTable(){
                table.render({
                    elem: '#demo'
                    ,url: '${ctx}/sys/bp/list' //数据接口
                    ,toolbar: '#toolbarDemo' //开启头部工具栏，并为其绑定左侧模板
                    ,page: true //开启分页
                    ,cols: [[ //表头
                        {type: 'checkbox', fixed: 'left'}
                        ,{field: 'name', title: '参数关键字', width:180, sort: true, fixed: 'left'}
                        ,{field: 'code', title: '参数编码', width:180, sort: true, fixed: 'left'}
                        ,{field: 'value', title: '参数值', width:180, sort: true, fixed: 'left'}
